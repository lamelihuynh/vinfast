                ...
                <div class="pointer-events-auto max-w-lg">
                    ...
                    <div class="mt-8 flex flex-col items-start gap-4">
                        <div class="flex flex-wrap gap-4">
                            <a href="<?= BASE_URL ?>products" class="group relative overflow-hidden rounded-full bg-gradient-to-r from-[#FFB81C] to-[#f59e0b] px-6 py-3 text-sm font-bold text-[#0b233f] shadow-[0_4px_15px_rgba(255,184,28,0.4)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_6px_20px_rgba(255,184,28,0.6)]">
                                <span class="relative z-10">XEM NGAY</span>
                            </a>
                            <a href="<?= BASE_URL ?>contact" class="rounded-full border-2 border-white/40 bg-white/5 backdrop-blur-sm px-6 py-3 text-sm font-bold text-white transition-all duration-300 hover:-translate-y-1 hover:bg-white hover:text-[#0b233f]">
                                TƯ VẤN
                            </a>
                        </div>
                        
                        <a href="<?= BASE_URL ?>contact?tab=test-drive" class="inline-flex items-center justify-center rounded-full border-2 border-[#FFB81C] px-6 py-3 text-sm font-bold text-[#FFB81C] transition-all duration-300 hover:-translate-y-1 hover:bg-[#FFB81C] hover:text-[#0b233f] hover:shadow-[0_4px_15px_rgba(255,184,28,0.4)]">
...
<section class="bg-white py-12">
    <div class="mx-auto max-w-6xl px-4">
        <h2 class="text-center text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#0b233f] to-[#1a4a82] uppercase tracking-wide drop-shadow-sm">DÒNG XE NỔI BẬT</h2>
                ...
                <?php foreach (array_slice($featured, 0, 3) as $p): ?>
                    <article class="group overflow-hidden rounded-2xl bg-white shadow-md ring-1 ring-slate-100 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
                        <a href="<?= BASE_URL ?>products/detail/<?= (int)($p['id'] ?? 0) ?>" class="block">
                            ...
                            <div class="p-5">
                                <h3 class="text-lg font-bold text-[#0b233f] transition-colors group-hover:text-[#1a4a82]"><?= htmlspecialchars((string)($p['name'] ?? '')) ?></h3>
                                ...
                                <div class="mt-4 flex items-center justify-between border-t border-slate-100 pt-4">
                                    <span class="text-base font-extrabold text-[#0b233f]"><?= htmlspecialchars(vf_product_price((array)$p)) ?></span>
                                    <span class="rounded-full bg-gradient-to-r from-[#0b233f] to-[#1a4a82] px-4 py-1.5 text-xs font-bold text-white shadow-md transition-transform group-hover:scale-105">XEM XE</span>
                                </div>
                            </div>
                        </a>
                    </article>
...
<section class="bg-[#0a2342] py-12 text-white">
    <div class="mx-auto grid max-w-6xl gap-6 px-4 lg:grid-cols-12 lg:items-center">
        ...
        <div class="lg:col-span-5 flex flex-col justify-center">
            ...
            <div class="mt-8">
                <a href="<?= BASE_URL ?>products" class="inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-[#FFB81C] to-[#f59e0b] px-8 py-3.5 text-sm font-bold text-[#0b233f] shadow-[0_4px_15px_rgba(255,184,28,0.4)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_6px_20px_rgba(255,184,28,0.6)]">
...
<section class="bg-[#f8fafc] py-12">
    <div class="mx-auto max-w-6xl px-4">
        <h2 class="text-center text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#0b233f] to-[#1a4a82] uppercase tracking-wide drop-shadow-sm">TẠI SAO CHỌN XE ĐIỆN VINFAST</h2>
        <div class="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <div class="group rounded-2xl bg-white p-6 text-center shadow-sm ring-1 ring-slate-100 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
                <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-[#f8fafc] text-2xl text-[#0b233f] transition-colors group-hover:bg-[#FFB81C] group-hover:text-white">
                    <i class="fa-solid fa-bolt"></i>
                </div>
                <p class="mt-4 text-base font-bold text-[#0b233f]">Hiệu suất tối ưu</p>
            ...
            <div class="group rounded-2xl bg-white p-6 text-center shadow-sm ring-1 ring-slate-100 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
                ...
                <p class="mt-4 text-base font-bold text-[#0b233f]">An toàn vượt trội</p>
            ...
            <div class="group rounded-2xl bg-white p-6 text-center shadow-sm ring-1 ring-slate-100 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
                ...
                <p class="mt-4 text-base font-bold text-[#0b233f]">Dịch vụ toàn diện</p>
            ...
            <div class="group rounded-2xl bg-white p-6 text-center shadow-sm ring-1 ring-slate-100 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
                ...
                <p class="mt-4 text-base font-bold text-[#0b233f]">Hướng đến bền vững</p>
...
<section class="bg-white py-16">
    <div class="mx-auto max-w-6xl px-4">
        <div class="text-center mb-12">
            <h2 class="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#0b233f] to-[#1a4a82] uppercase tracking-wide drop-shadow-sm">Hệ Sinh Thái Thông Minh</h2>
        ...
        <div class="grid gap-8 md:grid-cols-3">
            <div class="group relative overflow-hidden rounded-2xl bg-slate-50 p-8 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:bg-white ring-1 ring-slate-100">
                <div class="mb-6 flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br from-[#0b233f] to-[#1a4a82] text-white shadow-lg transition-transform group-hover:scale-110 group-hover:-rotate-3">
                    <i class="fa-solid fa-mobile-screen-button text-2xl"></i>
                </div>
                <h3 class="mb-3 text-xl font-bold text-[#0b233f]">Ứng dụng VinFast</h3>
            ...
            <div class="group relative overflow-hidden rounded-2xl bg-slate-50 p-8 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:bg-white ring-1 ring-slate-100">
                ...
                <h3 class="mb-3 text-xl font-bold text-[#0b233f]">Hạ tầng trạm sạc</h3>
            ...
            <div class="group relative overflow-hidden rounded-2xl bg-slate-50 p-8 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:bg-white ring-1 ring-slate-100">
                ...
                <h3 class="mb-3 text-xl font-bold text-[#0b233f]">Trợ lý ảo thông minh</h3>
...
<section class="bg-[#f8fafc] py-20 relative overflow-hidden">
    ...
    <div class="absolute -right-40 -top-40 h-96 w-96 rounded-full bg-gradient-to-br from-[#1a4a82]/5 to-[#0b233f]/5 blur-3xl pointer-events-none"></div>
    ...
    <div class="mx-auto grid max-w-6xl gap-12 px-4 lg:grid-cols-12 lg:items-center relative z-10">
        ...
        <div class="grid grid-cols-2 gap-4 lg:col-span-5">
            <div class="group relative overflow-hidden rounded-2xl shadow-sm transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-[#0b233f]/20">
            ...
            <div class="group relative mt-8 overflow-hidden rounded-2xl shadow-sm transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-[#0b233f]/20">
        ...
        <div class="lg:col-span-7 lg:pl-8">
            <div class="inline-flex items-center gap-3 rounded-full bg-white px-4 py-1.5 shadow-sm border border-slate-100 mb-6">
                ...
                <span class="text-[11px] font-bold uppercase tracking-widest text-[#0b233f]">CÂU CHUYỆN VINFAST</span>
            </div>
            
            <h3 class="text-3xl font-extrabold text-[#0b233f] sm:text-4xl leading-tight">
                Tiên phong vì một <br> <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#1a4a82] to-[#0b233f]">Việt Nam xanh hơn</span> mỗi ngày
            </h3>
            ...
            <div class="mt-8 grid gap-4 sm:grid-cols-2">
                <div class="flex items-start gap-4 rounded-xl bg-white p-4 shadow-sm ring-1 ring-slate-100 transition hover:shadow-md">
                    <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-[#f8fafc] text-[#0b233f]">
                        <i class="fa-solid fa-earth-americas text-lg"></i>
                    </div>
                    <div>
                        <h4 class="font-bold text-[#0b233f]">Tầm nhìn toàn cầu</h4>
                ...
                <div class="flex items-start gap-4 rounded-xl bg-white p-4 shadow-sm ring-1 ring-slate-100 transition hover:shadow-md">
                    ...
                    <div>
                        <h4 class="font-bold text-[#0b233f]">Tận tâm phục vụ</h4>
            ...
            <div class="mt-10">
                <a href="<?= BASE_URL ?>about" class="inline-flex items-center justify-center gap-2 rounded-full border-2 border-[#0b233f] bg-transparent px-8 py-3 text-sm font-bold text-[#0b233f] transition-all duration-300 hover:bg-[#0b233f] hover:text-white hover:shadow-lg">
