...
<style>
  .vfHomeHero .swiper-pagination-bullet { width: 28px; height: 4px; border-radius: 999px; background: rgba(255,255,255,.45); }
  .vfHomeHero .swiper-pagination-bullet-active { background: #fff; }
</style>
...
<section class="bg-[#f8fafc] py-12">
  <div class="mx-auto max-w-6xl px-4">
    ...
    <div class="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
      <div class="rounded-lg border border-slate-200 bg-white p-4 text-center"><i class="fa-solid fa-bolt text-xl text-[#0b233f]"></i><p class="mt-3 text-sm font-semibold">Hiệu suất tối ưu</p></div>
      <div class="rounded-lg border border-slate-200 bg-white p-4 text-center"><i class="fa-solid fa-shield-halved text-xl text-[#0b233f]"></i><p class="mt-3 text-sm font-semibold">An toàn vượt trội</p></div>
      <div class="rounded-lg border border-slate-200 bg-white p-4 text-center"><i class="fa-solid fa-screwdriver-wrench text-xl text-[#0b233f]"></i><p class="mt-3 text-sm font-semibold">Dịch vụ toàn diện</p></div>
      <div class="rounded-lg border border-slate-200 bg-white p-4 text-center"><i class="fa-solid fa-leaf text-xl text-[#0b233f]"></i><p class="mt-3 text-sm font-semibold">Hướng đến bền vững</p></div>
    </div>
  </div>
</section>
  ...
  <div class="mx-auto max-w-6xl px-4">
    ...
    <div class="mt-8 overflow-x-auto rounded-lg border border-slate-200">
      <table class="w-full min-w-[680px] text-sm">
        ...
        <tbody>
          <tr class="border-t"><td class="px-4 py-3 font-medium">Giá</td><td class="px-4 py-3"><?= htmlspecialchars(vf_product_price((array)($compareA ?? []))) ?></td><td class="px-4 py-3"><?= htmlspecialchars(vf_product_price((array)($compareB ?? []))) ?></td></tr>
          <tr class="border-t bg-slate-50"><td class="px-4 py-3 font-medium">Quãng đường</td><td class="px-4 py-3"><?= htmlspecialchars(vf_product_range((array)($compareA ?? []))) ?></td><td class="px-4 py-3"><?= htmlspecialchars(vf_product_range((array)($compareB ?? []))) ?></td></tr>
          <tr class="border-t"><td class="px-4 py-3 font-medium">Sạc nhanh</td><td class="px-4 py-3">24 phút (10-70%)</td><td class="px-4 py-3">30 phút (10-70%)</td></tr>
          <tr class="border-t bg-slate-50"><td class="px-4 py-3 font-medium">Bảo hành</td><td class="px-4 py-3">10 năm</td><td class="px-4 py-3">10 năm</td></tr>
        </tbody>
      </table>
    </div>
  </div>
...
<section class="bg-white py-12">
  <div class="mx-auto max-w-6xl px-4">
    ...
    <div class="mt-8 grid gap-4 md:grid-cols-3">
      <article class="rounded-lg border border-slate-200 p-5"><p class="text-sm text-slate-600">“Xe vận hành êm, sạc nhanh và tiết kiệm hơn kỳ vọng.”</p><p class="mt-4 text-sm font-semibold text-[#0b233f]">Nguyễn M.</p></article>
      <article class="rounded-lg border border-slate-200 p-5"><p class="text-sm text-slate-600">“Dịch vụ hậu mãi tốt, đội ngũ tư vấn hỗ trợ rất nhanh.”</p><p class="mt-4 text-sm font-semibold text-[#0b233f]">Trần H.</p></article>
      <article class="rounded-lg border border-slate-200 p-5"><p class="text-sm text-slate-600">“Thiết kế đẹp, nhiều công nghệ an toàn cho gia đình.”</p><p class="mt-4 text-sm font-semibold text-[#0b233f]">Lê K.</p></article>
    </div>
  </div>
</section>
