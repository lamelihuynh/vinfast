...
<section class="min-h-screen bg-slate-50 py-8">
    <div class="mx-auto w-full max-w-6xl px-4 lg:px-6">
        ...
        <!-- FLEX CHA -->
        <div class="flex flex-col lg:flex-row gap-6 items-start" id="vfCheckoutRoot"
                ...
                <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-[132px_1fr]">
                                ...
                                <?php foreach ($displayModels as $modelItem): ?>
                                    ...
                                    <button type="submit"
                                        ...
                                        <img src="<?= htmlspecialchars($modelItem['imageUrl'] ?: BASE_URL . 'public/images/products/default.jpg') ?>"
                                            class="mb-1 h-10 w-full object-cover rounded">

                                        <span class="text-[11px] font-semibold block truncate">
                        ...
                        <div class="bg-slate-50 p-6 lg:p-8">
                            ...
                            <!-- SPECS -->
                            <div class="mt-6 grid grid-cols-3 text-center divide-x bg-white rounded-xl py-4 shadow-sm border">
                                <div>
                        ...
                        <div class="flex items-center gap-2 pb-3">
                            <?php for ($step = 1; $step <= 3; $step++): ?>
                                <button type="button" data-step-tab="<?= $step ?>"
                                    ...
                                    <span class="w-5 h-5 inline-grid place-items-center rounded-full text-[10px]
                                        <?= $currentStep >= $step ? 'bg-vfNavy text-white' : 'border text-slate-400' ?>">
                                        <?= $step ?>
                                    </span>
