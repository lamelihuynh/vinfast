      ...
      <div id="vfProductsMega" class="absolute left-0 top-full w-[780px] max-w-[85vw] bg-white rounded-b-2xl border border-slate-200 shadow-2xl hidden group-hover:flex overflow-hidden">
        <div class="flex-1 p-6 grid grid-cols-2 gap-6">
          ...
          <div class="col-span-2 pt-4 border-t border-slate-100 flex flex-wrap gap-2">
            ...
            <a class="px-4 py-2 rounded-md border-2 border-[#FFB81C] text-[#FFB81C] text-[11px] font-semibold hover:bg-[#FFB81C] hover:text-vfNavy transition" href="<?= BASE_URL ?>products/checkout/94">Đặt cọc xe</a>
          </div>
        </div>
        <div class="w-64 bg-vfNavy p-5 flex flex-col">
          ...
          <a class="mt-auto text-center rounded-md bg-[#FFB81C] hover:bg-[#FFA500] transition text-vfNavy text-[11px] font-semibold py-2" href="<?= BASE_URL ?>products?q=VF+9">Khám phá ngay</a>
        </div>
      </div>
    </div>
